...
#define NEOPIXEL_PIN    2  // Pin de datos conectado a los aros NeoPixel
#define NUM_AROS        1   // Cantidad de aros NeoPixel
#define PIXELES_POR_ARO 8   // Pixels por aro
#define NUM_PIXELS      (NUM_AROS * PIXELES_POR_ARO)

Adafruit_NeoPixel aros(NUM_PIXELS, NEOPIXEL_PIN, NEO_GRB + NEO_KHZ800);
...
void setup() {
  ...
  aros.begin();
  aros.setBrightness(150); // Brillo del 0 al 255
  aros.clear();
  aros.show();
...
void encenderRojo() {
  for (int i = 0; i < NUM_PIXELS; i++) {
    aros.setPixelColor(i, aros.Color(255, 0, 0));
  }
  aros.show();
}
